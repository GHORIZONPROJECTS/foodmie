...
import { orderHistoryColumns } from '../../data/dataSource';
            ...
            renderCell:(params) => {
                return(
                    <div className='cellAction'>
                       <Link to={`/orderHistory/${params.row.id}`} style={{textDecoration:"none"}}>
    ...
    <div className="datatable">
      ...
      {isLoading ? <Spinner/> : 
        <DataGrid
            ...
            rows={data}
            columns={orderHistoryColumns.concat(actionColumn)}
            pageSize={5}
